...
const da: Dictionary = {
  ...
  "trial.forWhom": "Hvem skal bruge ReliefRead?",
  "trial.forWhomPlaceholder": "Vælg en mulighed",
  "trial.myself": "Mig selv",
  "trial.child": "Mit barn",
  "trial.student": "En elev eller studerende",
  "trial.other": "En anden",
