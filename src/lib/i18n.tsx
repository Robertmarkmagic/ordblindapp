...
const da: Dictionary = {
  ...
  "trial.back": "Tilbage til forsiden",
  "trial.badge": "Gratis prøveadgang",
  "trial.title": "Prøv ReliefRead gratis",
  "trial.intro": "Tilmeld dig prøveperioden. Du skal ikke bruge betalingskort, adgangskode eller en ordblindediagnose.",
  "trial.benefit1": "Prøv læse- og skrivehjælpen i ro og mag",
  "trial.benefit2": "Hjælp os med at gøre ReliefRead endnu bedre",
  "trial.benefit3": "Ingen betaling i prøveperioden",
  "trial.formTitle": "Tilmeld dig her",
  "trial.name": "Navn",
  "trial.namePlaceholder": "Dit navn",
  "trial.email": "E-mail",
  "trial.emailPlaceholder": "dig@eksempel.dk",
  "trial.purpose": "Hvad skal du bruge ReliefRead til?",
  "trial.purposePlaceholder": "Vælg en mulighed",
  "trial.work": "Arbejde",
  "trial.education": "Skole eller uddannelse",
  "trial.personal": "Privat brug",
  ...
  "trial.mailNote": "Når du trykker, åbner din mail med tilmeldingen klar. Send mailen, så kontakter vi dig om prøveadgangen.",
  "trial.sentTitle": "Din tilmelding er klar",
  "trial.sentText": "Din mail-app er åbnet med oplysningerne. Send mailen for at færdiggøre tilmeldingen.",
  "trial.openMail": "Åbn mailen igen",
  "trial.copy": "Kopiér tilmeldingen",
  "trial.copied": "Tilmeldingen er kopieret",
  "trial.contact": "Har du spørgsmål? Skriv til hello@reliefread.com",
  ...
  "notes.eyebrow": "Dine tanker",
  "notes.title": "Mine noter",
  "notes.intro": "Alt det, du har skrevet under læsningen, samlet ét roligt sted.",
  "notes.search": "Søg i noter og læsninger",
  "notes.count": "{count} noter",
  "notes.error": "Vi kunne ikke hente dine noter lige nu. Prøv igen om et øjeblik.",
  "notes.untitled": "Unavngivet læsning",
  "notes.emptyTitle": "Din første note starter med en læsning",
  "notes.emptyText": "Åbn en læsning, markér et afsnit, og skriv det, du vil huske.",
  "notes.startReading": "Start en læsning",
  "notes.noResults": "Ingen noter passer til din søgning",
  "notes.clearSearch": "Ryd søgningen",
  "notes.emptyNote": "Tryk for at skrive din note",
  "notes.openReading": "Åbn læsning",
  "notes.color": "Notens farve",
  "notes.editorHelp": "Skriv frit. Din note gemmes automatisk.",
  "notes.saving": "Gemmer",
  "notes.saved": "Gemt",
